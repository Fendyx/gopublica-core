...
export default function CategoryNavSidebar({ categories }: CategoryNavSidebarProps) {
  ...
  return (
    <aside className="hidden lg:block sticky top-16 z-40 w-64 shrink-0 h-[calc(100vh-4rem)] overflow-y-auto border-r border-gray-200 bg-background/80 backdrop-blur-sm">
      <div className="py-4">
