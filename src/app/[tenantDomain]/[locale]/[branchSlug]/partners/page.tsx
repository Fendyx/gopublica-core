// src/app/[tenantDomain]/[locale]/[branchSlug]/partners/page.tsx
...
async function resolveDynamicItems(
  ...
  try {
    ...
    console.error('[partners] page: fetchMenu failed:', err);
    return new Map();
  }
...
export default async function PartnersPage({
  ...
  try {
    ...
    console.error('[partners] page: fetchBranchBySlug failed:', err);
  }
  ...
  if (!sections || sections.length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <h1 className="text-2xl">No partner content available for this branch</h1>
      </div>
    );
  }
